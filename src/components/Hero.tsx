            ...
            <div className="group relative bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 text-center hover:bg-white/20 transition-all duration-500 border border-white/20 hover:border-white/40 hover:scale-105 transform shadow-xl hover:shadow-2xl">
              ...
              <div className="relative">
                <div className="relative inline-block mb-4 sm:mb-6">
                  ...
                  <div className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-pink-500 via-rose-500 to-pink-600 rounded-full flex items-center justify-center shadow-lg">
                    <Calendar className="h-8 w-8 sm:h-10 sm:w-10 text-white" strokeWidth={2.5} />
                  </div>
                </div>
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-white mb-2 sm:mb-3">イベント</h3>
                <p className="text-xs sm:text-sm text-white/90 leading-relaxed">
