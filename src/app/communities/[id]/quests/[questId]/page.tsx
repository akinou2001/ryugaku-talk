...
export default function QuestDetail() {
  ...
  const isOwner = quest?.community?.owner_id === user?.id
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link href={`/communities/${communityId}?tab=quests`} className="btn-primary">
            クエスト一覧に戻る
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <Link
            href={`/communities/${communityId}?tab=quests`}
